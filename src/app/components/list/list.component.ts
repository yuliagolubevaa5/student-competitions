...
export class ListComponent implements OnInit {
  ...
  typesOfData: string[] = ['Web-программирование', 'Бизнес-планирование IT-проектов ', 'Искусственный интеллект и экспертные системы ', 'Компьютерная безопасность ', 'Методы оптимизации'];
  clicked = false;
